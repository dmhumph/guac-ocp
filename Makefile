...
deploy:
	...
	docker run -it -e GUACD_HOSTNAME=localhost -e GUACD_PORT=4822 -e MYSQL_DATABASE=guacamole_db -e MYSQL_USER=guacamole_user -e MYSQL_PASSWORD=some_password -e MYSQL_HOSTNAME=127.0.0.1 -e MYSQL_PORT=3306 -p 8080:8080 -p 9990:9990 guacamole-client source/guacamole-docker/bin/start.sh
